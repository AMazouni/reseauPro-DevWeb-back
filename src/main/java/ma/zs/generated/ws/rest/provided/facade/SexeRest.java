...
public class SexeRest {
	...
	@ApiOperation("Finds a  sexe by ref")
    @GetMapping("/ref/{ref}")
	public SexeVo findByRef(@PathVariable String ref){
		return  sexeConverter.toVo(sexeService.findByRef(ref));
	}
	@ApiOperation("Deletes a  sexe by ref")
